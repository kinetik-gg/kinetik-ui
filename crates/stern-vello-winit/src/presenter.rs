...
use stern_render::RenderFrameInput;
use stern_vello::{VelloNativeTextureRegistry, VelloNativeTextureScope, VelloRenderer};
use vello::{
...
impl PresentOperations for RealPresentOperations<'_> {
    ...
    fn encode_scene(&mut self, input: RenderFrameInput<'_>) -> stern_render::RenderFrameOutput {
    ...
    fn blit_submit(&mut self, frame: &Self::Frame) {
        ...
        let mut encoder = device
            ...
            .create_command_encoder(&CommandEncoderDescriptor {
                label: Some("stern-vello-winit-blit"),
            });
