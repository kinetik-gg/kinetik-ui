...
fn stage2_property_grid_experimental_status_is_backed_by_layout_and_row_state_metadata() {
    ...
    let rows = [
        PropertyGridRow::section(stern_widgets::ItemId::from_raw(1), "Transform")
            .with_help_text("Object transform"),
        PropertyGridRow::property(stern_widgets::ItemId::from_raw(2), "Position X", 1)
            .with_required(true)
            .with_status(PropertyGridRowStatus::warning("Outside guide range")),
        PropertyGridRow::property(stern_widgets::ItemId::from_raw(3), "Script", 0).with_state(
...
fn property_grid_experimental_status_includes_affordance_request_contracts() {
    ...
    let row = PropertyGridRow::property(stern_widgets::ItemId::from_raw(7), "Exposure", 0)
...
fn property_grid_status_semantics_include_warning_error_and_info_metadata() {
    ...
    let rows = [
        PropertyGridRow::property(stern_widgets::ItemId::from_raw(1), "Mode", 0),
        PropertyGridRow::property(stern_widgets::ItemId::from_raw(2), "Hint", 0)
            .with_status(PropertyGridRowStatus::info("Inherited from parent")),
        PropertyGridRow::property(stern_widgets::ItemId::from_raw(3), "Exposure", 0)
            .with_status(PropertyGridRowStatus::warning("Preview range exceeded")),
        PropertyGridRow::property(stern_widgets::ItemId::from_raw(4), "Mass", 0)
