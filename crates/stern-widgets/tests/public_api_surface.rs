...
use stern_core::{Rect, UiInput, UiMemory, WidgetId, default_dark_theme};
use stern_widgets::{self as widgets, prelude};
...
fn prelude_exports_common_application_widget_items() {
    ...
    let surface = prelude::ViewportSurface {
        texture: stern_core::TextureId::from_raw(1),
        source_size: stern_core::Size::new(100.0, 100.0),
...
fn root_exports_access_aware_text_field_api_without_expanding_prelude_usage() {
    ...
    let mut memory = UiMemory::new();
    let mut single = stern_text::TextEditState::new("single");
    let mut multi = stern_text::TextEditState::new("multi\nline");
...
fn text_wrapper_signatures_and_output_shapes_remain_source_compatible() {
    ...
    let mut numeric_state = stern_text::TextEditState::new("1");
    ...
    let mut search_state = stern_text::TextEditState::new("find");
    ...
    let mut scrub_state = stern_text::TextEditState::new("1");
    ...
    let mut path_state = stern_text::TextEditState::new("src/lib.rs");
    ...
    let mut states = [
        stern_text::TextEditState::new("1"),
        stern_text::TextEditState::new("2"),
    ];
    ...
    let mut memory = UiMemory::new();
    let mut ui_numeric = stern_text::TextEditState::new("1");
    let mut ui_search = stern_text::TextEditState::new("find");
    let mut ui_path = stern_text::TextEditState::new("src/lib.rs");
    let mut ui_value = 1.0;
    let mut ui_scrub = stern_text::TextEditState::new("1");
...
fn affected_wrapper_root_prelude_and_layout_paths_compile_call() {
    use stern_text::{TextEditState, TextLayoutStore};
