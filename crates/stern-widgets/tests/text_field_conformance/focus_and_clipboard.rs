...
fn text_field_clipboard_requests_are_targeted_and_targeted_text_is_applied() {
    ...
    let clipboard_input = UiInput {
        clipboard_text: vec![
            stern_core::ClipboardText::new(other, "wrong"),
            stern_core::ClipboardText::new(id, "XY"),
        ],
        ..UiInput::default()
    };
...
fn unfocused_and_disabled_text_fields_ignore_clipboard_shortcuts_and_targeted_text() {
    ...
    let input = UiInput {
        ...
        clipboard_text: vec![stern_core::ClipboardText::new(id, "XY")],
        ..UiInput::default()
    };
...
fn targeted_clipboard_text_replaces_existing_selection_with_undo() {
    ...
    let input = UiInput {
        clipboard_text: vec![
            stern_core::ClipboardText::new(other, "wrong"),
            stern_core::ClipboardText::new(id, "é"),
        ],
        ..UiInput::default()
    };
