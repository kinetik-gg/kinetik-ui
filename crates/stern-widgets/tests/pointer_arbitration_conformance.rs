...
fn run_frame(
    ...
    ScrollAreaOutput<(stern_core::Response, stern_core::Response)>,
    stern_core::FrameOutput,
) {
    let theme = stern_core::default_dark_theme();
    ...
    ui.resolve_pointer_targets(|plan| {
        ...
        plan.with_clip(VIEWPORT, |plan| {
            plan.with_transform(
                stern_core::Transform::translation(Vec2::new(0.0, -frame_offset.y)),
                |plan| {
                    if reverse {
